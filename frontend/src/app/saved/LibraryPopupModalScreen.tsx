...
export default function LibraryPopupModalScreen() {
  ...
  const toggleBookmark = () => setSaved(activityId, !currentlySaved);
...
const styles = StyleSheet.create({
  ...
  cardTitle: { fontSize: 16, fontWeight: "800", color: "#1E2A5A" },
  cardSub: { marginTop: 6, fontSize: 13, color: "#2F3E75", opacity: 0.8 },
  iconCircle: {
    width: 38,
    height: 38,
    borderRadius: 19,
  ...
  sectionTitle: { fontSize: 22, fontWeight: "800", color: "#1E2A5A" },
  createNew: { fontSize: 14, fontWeight: "600", color: "#2F3E75" },
  empty: { textAlign: "center", color: "#8A8FA3", marginTop: 30, fontSize: 14 },
  playlistRow: {
    flexDirection: "row",
    alignItems: "center",
    borderRadius: 16,
  ...
  playlistName: { fontSize: 16, fontWeight: "800", color: "#1E2A5A" },
  playlistSub: { marginTop: 4, fontSize: 13, color: "#8A8FA3" },
  checkCircle: {
    width: 28,
    height: 28,
    borderRadius: 14,
