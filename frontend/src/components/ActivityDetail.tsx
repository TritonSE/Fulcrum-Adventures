...
const DocumentIcon = () => (
  <Svg width={18} height={22} viewBox="0 0 18 22" fill="none">
    <Path
      d="M0.75 1.75C0.75 1.19771 1.19771 0.75 1.75 0.75H11.75L16.75 5.75V19.75C16.75 20.3023 16.3023 20.75 15.75 20.75H1.75C1.19771 20.75 0.75 20.3023 0.75 19.75V1.75Z"
      stroke="#153A7A"
      strokeWidth="1.5"
      strokeLinejoin="round"
    />
